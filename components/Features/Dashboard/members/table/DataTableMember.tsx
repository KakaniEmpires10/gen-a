...
import { Search, RefreshCw, UserPlus2, AlertCircleIcon } from "lucide-react";
...
export function DataTableMember<TData extends Member, TValue>({
    columns,
}: DataTableProps<TData, TValue>) {
    const [columnFilters, setColumnFilters] = useState<ColumnFiltersState>([]);

    const { data: memberData, error, isLoading, isValidating } = useSWR<MemberResponse[] | []>('/api/members');
                ...
                <div className="flex gap-2">
                    ...
                    <Button asChild>
                        <Link href="/dashboard/members/add">
                            <UserPlus2 className="size-4" /> Tambah Anggota
                        </Link>
                    </Button>
                </div>
            </div>
