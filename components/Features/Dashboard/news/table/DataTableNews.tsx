...
import { AlertCircleIcon, FilePlus, RefreshCw, Search } from "lucide-react";
...
export function DataTableNews<TData extends News, TValue>({
    columns,
        ...
        <>
                ...
                <div className="flex gap-2">
                    ...
                    <Button asChild>
                        <Link href="/dashboard/news/add">
                            <FilePlus className="size-4" /> Tambah Berita
                        </Link>
                    </Button>
                </div>
            </div>
            ...
            <div className="relative mt-8">
                <Alert className="absolute -top-10 left-0 right-0 w-[95%] m-auto z-[5]">
                    ...
                    <AlertDescription>
                        Disini nih buat lihat daftar Berita &nbsp;
                ...
                <div className="overflow-x-auto">
                    <Table className="border-t-4 border-primary border-b-2 w-full">
                        ...
                        <TableBody>
                            {(isLoading || isValidating && !newsData) ? (
                                <TableRow>
                                    <TableCell
